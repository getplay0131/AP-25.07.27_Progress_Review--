...
class _ScheduleContentState extends State<ScheduleContent> {
  ...
  void didChangeDependencies() {
    ...
    var argsMap = args is Map<String, dynamic> ? args : {};
    if (argsMap != null) {
      setState(() {
        title = argsMap['title'] ?? "제목 없음";
        date = argsMap['date'] ?? DateTime.now();
        description = argsMap['description'] ?? "설명 없음";
        location = argsMap['location'] ?? "위치 없음";
        isCompleted = argsMap['isCompleted'] ?? false;
    ...
    print("위치 : $location");
    print("완료여부 : ${isCompleted == true ? "완료" : "미완료"}");
  }
